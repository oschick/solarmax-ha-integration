...
from custom_components.solarmax.solarmax_api import SolarmaxConnectionError, SolarmaxTimeoutError
from custom_components.solarmax.const import DOMAIN, CONF_HOST, CONF_PORT, CONF_UPDATE_INTERVAL
