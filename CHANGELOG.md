...
- **Minimum Home Assistant version is now 2024.12.0** (raised again within this same unreleased cycle, superseding the 2024.8.0 previously stated here). The options flow relies on the `OptionsFlow.config_entry` property, which shipped in Home Assistant 2024.12.
